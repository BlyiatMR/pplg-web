<template>
    <section class="">
        <div class="max-w-[1280px] relative mx-auto max-xl:mx-10 py-20">
          ...
          <h1 class="max-w-7xl mx-auto text-center font-semibold sm:text-4xl text-3xl text-white leading-tight">Keunggulan PPLG</h1>
          <div class="flex justify-center flex-wrap py-20 space-y-10">
            <div class="flex justify-center gap-10 flex-wrap gap-x-40">
              <div v-for="(card, index) in cards" :key="index" class="max-w-lg flex gap-5 items-start py-5">
      ...
      cards: [
        {
          ...
          src: "/src/assets/images/icon/icon-curicullum.png",
        },
        {
          ...
          src: "/src/assets/images/icon/icon-computer.png",
        },
        {
          ...
          src: "/src/assets/images/icon/icon-job.png",
        },
        {
          ...
          src: "/src/assets/images/icon/icon-people.png",
        },
      ]
    };
  }
