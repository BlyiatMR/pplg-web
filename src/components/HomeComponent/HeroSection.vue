<template>
    <section class="max-w-[1240px] mx-auto max-xl:mx-5 flex flex-wrap sm:justify-between justify-start z-50 mt-28 max-[1015px]:mb-28">
        <div class="sm:max-w-xl w-fit space-y-5 sm:pt-24 pt-10">
